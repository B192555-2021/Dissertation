...
for (i in 1:(nrow(chrom_position1)-1))
  ...
  print(chr_plus)
  pi10000_2[which(pi10000_2$CHROM == chr),2] <- pi10000_2[which(pi10000_2$CHROM == chr),2] + chr_plus
  pi10000_2[which(pi10000_2$CHROM == chr),3] <- pi10000_2[which(pi10000_2$CHROM == chr),3] + chr_plus
}

ggplot_Nsnp <- ggplot() +
geom_bar(data = pi10000_2,
...
remove(pi10000_2, chrom_position1, chrom_position_file1)
```
...
labs(x="PI", y="Density", title="PI density") +
...
theme_classic() +
guides(color=guide_legend(title="Window size")) +
labs(x="Tajima's D", y="Density", title="Tajima's D density") +
  theme(legend.position=c(.8, .9),
        axis.title = element_text(size = 15),
        axis.text = element_text(size = 15),
        axis.text.x = element_text(angle = 60, hjust = 1),
...
theme_classic() +
guides(color=guide_legend(title="Chromosome")) +
labs(x="chromosome position", y="Likelihood ratio", title="Sweepfinder2 result of all chromosomes") +
  theme(legend.position="top",
        axis.title = element_text(size = 15),
        axis.text = element_text(size = 15),
        axis.text.x = element_blank(),
